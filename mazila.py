...
def test_user_registration(opencart_page):
    ...
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_email']", "katetest1@yandex.ru")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_password']", "Rgtj456704")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_confirm_password']", "Rgtj456704")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_firstname']", "Ekaterina")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_lastname']", "Polozhentseva")
    step_input_text(opencart_page, By.XPATH, "//input[@id='register_telephone']", "79779368202")
